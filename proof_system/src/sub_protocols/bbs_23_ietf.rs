...
use bbs_plus::{
    prelude::{
        BBSPlusError, PreparedPublicKeyG2, PreparedSignatureParams23G1, PublicKeyG2,
        SignatureParams23G1,
    },
...
pub struct PoKBBSSigIETFG1SubProtocol<'a, E: Pairing> {
    pub id: usize,
...
impl<'a, E: Pairing> PoKBBSSigIETFG1SubProtocol<'a, E> {

    ...
    G: AffineCurve,
{
    ...
    >(
        ...
        Ok(Self::compressed_response::<F, H>(
            z,
            g.to_vec(),
            f.clone(),
            transcript,
    ...
    fn compression() {
        fn check_compression(size: usize) {
            ...
            rand_comm
                ...
                .unwrap();
            let verifier_challenge = verifier_transcript_1.hash::<Fr, Blake2b>(None);
            response
            ...
            rand_comm
                ...
                .unwrap();
            let verifier_challenge = verifier_transcript_2.hash::<Fr, Blake2b>(None);
            response
                .is_valid::<_, Blake2b>(
                    &g,
                    &P,

...
template PoseidonEx(nInputs, nOuts, curveType) {
    ...
    var C[t*nRoundsF + nRoundsP] = POSEIDON_C(curveType, t);
    var S[  N_ROUNDS_P[t-2]  *  (t*2-1)  ]  = POSEIDON_S(curveType, t);
    var M[t][t] = POSEIDON_M(curveType, t);
    var P[t][t] = POSEIDON_P(curveType, t);
...
template Poseidon(nInputs, curveType) {
    signal input inputs[nInputs];
    signal output out;

    component pEx = PoseidonEx(nInputs, 1, curveType);
    pEx.initialState <== 0;
